...
export class UriService {
    ...
    buildHooplacartServiceUri() {
        return this.hooplacartServiceUri.protocol + 
            "://" + this.hooplacartServiceUri.host + 
            ":" + this.hooplacartServiceUri.port + 
            "/" + this.hooplacartServiceUri.applicationName;
    }
